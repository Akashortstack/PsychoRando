function RandoPurse(Ob)
	...
	if (Ob == nil) then 	
		...
		Ob.sBaggageType = 'purse' -- Editable
		Ob.animTimerID = '1'
		Ob.dieTimerID = '2'
	...
	function Ob:onBeginLevel()		  
		...
		if ( levelPrefix == 'BV' ) then
			--edit
			SetBaseTexture(self, 'Textures/Collectibles/co_purse_BV.dds')
		end
		--edit
		SetActionTable(self, 'Anims/Emotional Baggage/purse.asd')
