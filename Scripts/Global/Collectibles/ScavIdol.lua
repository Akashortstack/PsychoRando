...
--edited name to match
function ScavIdol(Ob)

	if (Ob == nil) then
		Ob = CreateObject('Global.Props.HeldObject')
		--edit meshName to match
		Ob.meshName = 'Levels/CA_Campgrounds/Props/CA_ScavIdol.plb' -- Editable
		...
		--edit pickupSpriteName to match
		Ob.pickupSpriteName = 'Scav_Idol'	-- Editable
