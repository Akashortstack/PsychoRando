function APBaggageHints(Ob)
    ...
    function Ob:getFilePath()
        ...
        local filePath = folderName.."/BaggageHints.txt"
        return filePath
    end

    function Ob:writeBaggageHint(location_id)
    ...
    --Prints baggage checked in RandoSeed.lua table formatting
    function Ob:findBaggageID(name)
